...
Open up a notebook (physical, digital...whatever you take notes in best), and **take notes** while you go through these readinygs:
...
Create a zip file of all the files in your R project folder for this assignment and submit it on the corresponding assignment submission on Blackboard. (Ignore the instructions at the [top of this page]() - that will be the instructions for all future assignments).
