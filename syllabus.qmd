...
Quizzes               | 9 %    | 5 quizzes, lowest dropped
...
With this in mind, the use of AI tools is in general permitted, but with caveats. If you do use AI tools on assignments in this class, you must include the prompt(s) you used as well as changed to made to them to get better results to receive full credit.
