...
# 3. Specify the Conjoint Question 

Write the text of a conjoint choice question you plan on asking your respondents. This needs to be a specific choice question. Below your question, list in a table the attributes and levels you will include in your conjoint questions (these may change between now and the actual final survey). 

For example, for a survey on car preferences, you might use this as a question:

> "If these were your only options, which vehicle would you choose?"

And you might use these as some possible attributes and levels:
