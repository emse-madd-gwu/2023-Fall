...
Include a clearly legible image of your model relationships table identifying the basic features of your _product attributes_ as well as the features of current competitors. Use [this example](https://docs.google.com/spreadsheets/d/1iwMI9cbJjB6J8wghZY6Y_fCOSt7MDsUTnSuuC58_xjU/edit?usp=sharing) as a template.
...
Click the "Render" button to compile your `proposal.qmd` file into a html web page, then create a zip file of everything in your R Project folder. Submit your zip file on Blackboard - only one person from your team should submit the report.
