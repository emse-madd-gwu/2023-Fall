...
- Review the slide design guidelines discussed in [class](https://madd.seas.gwu.edu/2023-Fall/class/15-communicating-results.html) as a check list when designing your slides.
